...
namespace Vue2Spa.Controllers.Admin
{
    ...
    public class CategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ParentId,Name,DisplayOrder")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,ParentId,Name,DisplayOrder")] Category category)
        {
            if (id != category.Id)
            {
                return NotFound();
