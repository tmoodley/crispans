    ...
    methods: { 
      ...
      onOptionClick({ option, addTag }) {
        ...
        var payload = {
          ...
          PurchaseOrderId: this.store.purchaseOrder.id
        } 
      ...
      onRemoveClick(tag) { 
        ...
        this.removeCategory(payload);
      },
      getCategories() {
        var self = this;
        var cats = [];
        if (self.store.purchaseOrder.purchaseOrderCategories != null) {
          cats = self.store.purchaseOrder.purchaseOrderCategories.map(x => x.categoryId);
        }
        return axios
