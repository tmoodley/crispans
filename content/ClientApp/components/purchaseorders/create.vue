                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input v-model="purchaseOrder.PurchaseDate" type="date" class="form-control" @blur="$v.purchaseOrder.PurchaseDate.$touch()" />
                      <p :class="{ invalided: validate }" style="color: red;" v-if="!$v.purchaseOrder.PurchaseDate.required"> This field must not be empty</p>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="DeliveryDate" class="control-label">Delivery Date</label>
                      <input v-model="purchaseOrder.DeliveryDate" type="date" class="form-control" @blur="$v.purchaseOrder.DeliveryDate.$touch()" />
                      <p :class="{ invalided: validate }" style="color: red;" v-if="!$v.purchaseOrder.DeliveryDate.required"> This field must not be empty</p>
                    </div>
                  </div>
                  <div class="col-md-6" :class="{invalid: $v.purchaseOrder.PurchaseOrderNumber.$error}">
                    <div class="form-group">
                      ...
                      <p :class="{ invalided: validate }" style="color: red;" v-if="!$v.purchaseOrder.PurchaseOrderNumber.required"> This field must not be empty</p>
                    </div>
                  </div>
                </div>
                <div class="row">
                ...
                <div class="row" v-for="(item, index) in purchaseOrder.PurchaseOrderItems">
                  <div class="col-md-3">
                    <div class="form-group" :class="{invalid: $v.purchaseOrder.PurchaseOrderItems.$each[index].item.$error}">
                      ...
                      <p :class="{ invalided: validate }" style="color: red;" v-if="!$v.purchaseOrder.PurchaseOrderItems.$each[index].item.required"> This field must not be empty</p>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
                  ...
                  <div class="col-md-2">
                    <div class="form-group" :class="{invalid: $v.purchaseOrder.PurchaseOrderItems.$each[index].quantity.$error}">
                      ...
                      <p :class="{ invalided: validate }" style="color: red;" v-if="!$v.purchaseOrder.PurchaseOrderItems.$each[index].quantity.required"> This field must not be empty</p>
                    </div>
                  </div>
                  <div class="col-md-2">
                    <div class="form-group" :class="{invalid: $v.purchaseOrder.PurchaseOrderItems.$each[index].amount.$error}">
                      ...
                      <p :class="{ invalided: validate }" style="color: red;" v-if="!$v.purchaseOrder.PurchaseOrderItems.$each[index].amount.required"> This field must not be empty</p>
...
<script>
  ...
  export default { 
      ...
      methods: {
        ...
        onComplete: function () {
           event.preventDefault(); // prevent submit form refresh the page
            var self = this;
