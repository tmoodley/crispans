<template> 
  <div class="main-nav">
    <nav class="navbar navbar-expand-md navbar-dark navbar-nav bg-gradient-primary sidebar sidebar-dark accordion">
      ...
      <router-link class="navbar-brand" to="/"><icon :icon="['fab', 'microsoft']" /> Admin</router-link>
