...
export const routes = [
  ...
  { name: 'createtender', path: '/portal/tender/create', component: Job, display: 'Create Tender', icon: 'info', showOnMenu: true, beforeEnter: ifAuthenticated },
  { name: 'searchtender', path: '/portal/tender/search', component: Jobs, display: 'Search Tenders', icon: 'list', showOnMenu: true, beforeEnter: ifAuthenticated },
  ...
  { name: 'CreatePO', path: '/portal/PurchaseOrders/Create', component: CreatePurchaseOrder, display: 'Create Purchase Order', icon: 'home', showOnMenu: true, beforeEnter: ifAuthenticated },
  ...
  { name: 'Orders', path: '/portal/PurchaseOrders/Manage', component: PurchaseOrders, display: 'Purchase Orders', icon: 'home', showOnMenu: true, beforeEnter: ifAuthenticated },
  { name: 'CreateProduct', path: '/portal/Products/Create', component: Product, display: 'Create Product', icon: 'info', showOnMenu: true, beforeEnter: ifAuthenticated },
  { name: 'SearchProduct', path: '/portal/Products/Manage', component: Products, display: 'Search Products', icon: 'list', showOnMenu: true, beforeEnter: ifAuthenticated },
  ...
  { name: 'ManageMyBids', path: '/portal/mybids/', component: MyBids, display: 'My Bids', icon: 'list', showOnMenu: true, beforeEnter: ifAuthenticated },
  {
    name: 'login',
    path: '/login',
    component: LoginPage,
